...
//        description.setText("需要展示的内容");
    ...
    public void showLineChart(final List<Integer> dataList, String name, int color) {
     ...
     */
    public void resetLine(int position, List<Integer> dataList, String name, int color) {
